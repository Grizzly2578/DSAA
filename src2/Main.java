...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Only populate default items if inventory is empty (prevents duplicates when loading from JSON)
        if (inventory.getMenuCatalog() == null || inventory.getMenuCatalog().isEmpty()) {
        ...
        while (running) {
            ...
            switch (choice) {
                case 1 -> inventory.displayCatalog();
                ...
                case 6 -> salesManager.generateEODReportInsertionSort();

                case 7 -> System.out.print("Empty Choice ");
